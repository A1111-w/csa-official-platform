...
public class StoredFileController {
    ...
    public StoredFileController(FileService fileService, ResourceMapper resourceMapper, AuditService auditService) {
    ...
    public ResponseEntity<FileSystemResource> download(@PathVariable Long ownerId,
        ...
        if (!effectiveOwnerId.equals(currentUserId) && !isPublishedResource(fileUrl)) {
